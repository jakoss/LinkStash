...
- Pending: final manual emulator verification of authenticated in-app flow using a local test token (login completion + share-save into Inbox + move/delete checks).
